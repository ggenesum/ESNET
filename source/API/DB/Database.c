...
static int __GetUserId(char* username, sqlite3* db){
    sqlite3_stmt *res;
...
static int __Username_exists(char* Username,sqlite3* db){
    sqlite3_stmt *res;
    char *sql = "SELECT Id FROM User WHERE Username = ?1;";
...
int Auhtenticate(char* username, char* email, char* pass, struct login_cookie login_cookie, sqlite3 *db){
    sqlite3_stmt *res;
